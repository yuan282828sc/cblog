...
$("#friend_link").click(function () {
    layer.alert("请附友链,发送邮箱到:1582691494@qq.com",
        {
...
layui.use(['element', 'layer'], function () {
    ...
    var util = layui.util;
    $("#box").click(function () {
        layer.alert("有想法,请发送邮件到:1582691494@qq.com",
            {
                skin: 'layui-layer-lan'
                , closeBtn: 0
                , title: '联系站长'
...
$('.fly-search').on('click', function () {
    layer.open({
        ...
        , content: ['<form action="http://search.cblog.com/search">'
            , '<input autocomplete="off" placeholder="搜索内容或用户，回车跳转" type="text" name="keyword">'
            , '</form>'].join('')
